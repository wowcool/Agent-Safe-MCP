      ...
      <main className="container mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="space-y-10 text-white/80 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              The Service charges $0.02 USD per email safety check. Payment is processed through the Skyfire Network using PAY tokens. By submitting a request with a valid Skyfire PAY token, you authorize the charge for that request.
            </p>
