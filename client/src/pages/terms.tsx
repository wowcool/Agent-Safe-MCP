  ...
  return (
    <div className="min-h-screen" style={{ background: "#0f1012", color: "#e5e5e5", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main className="container mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="text-white/40 text-sm mb-12">Last updated: February 11, 2026</p>
        ...
        <div className="space-y-10 text-white/80 text-sm leading-relaxed">
          <section>
            ...
            <p>
              Agent Safe ("Service") is a Remote MCP (Model Context Protocol) Server operated by Alibi Ledger, LLC ("Company," "we," "us") that provides a 6-tool email security suite for AI agents. The Service includes the following tools: check_email_safety (email threat analysis), check_url_safety (URL analysis), check_response_safety (draft reply checking), analyze_email_thread (conversation thread analysis), check_attachment_safety (attachment risk assessment), and check_sender_reputation (sender identity verification with live DNS DMARC and RDAP domain age checks). All tools provide advisory analysis powered by AI and return structured safety assessments.
            </p>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mb-3">
              The Service charges $0.02 USD per tool call across all 6 tools. Payment is processed through the Skyfire Network using PAY tokens. By submitting a request with a valid Skyfire PAY token, you authorize the charge for that request.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Use the Service solely for email security analysis purposes. The tools are designed for evaluating emails, URLs, attachments, sender identities, draft replies, and email threads — not for any other content analysis.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Analysis results across all 6 tools are advisory only. The Service uses AI (Anthropic Claude) to assess security risks and may produce false positives (flagging safe content as dangerous) or false negatives (missing actual threats). No tool in the suite provides a guarantee of threat detection.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Each tool in the suite (check_email_safety, check_url_safety, check_response_safety, analyze_email_thread, check_attachment_safety, check_sender_reputation) provides advisory analysis that may contain errors, omissions, or inaccuracies.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1.5 mb-3">
              ...
              <li>Consequences arising from reliance on any of the 6 tools' analysis, including but not limited to email safety verdicts, URL risk scores, attachment safety assessments, sender reputation evaluations, thread manipulation detection, or draft reply recommendations.</li>
            </ul>
            <p>
